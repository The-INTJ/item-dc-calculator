...
export default function HomePage() {
  return (
    <AppShell currentApp="mixology">
      <div className="mixology-landing">
        <section className="mixology-hero">
          <h1>Mixology Rating App</h1>
          <p>
            A contest-first experience for judging, scoring, and tracking craft cocktail matchups. The mixology
            flow is the primary entry point for event usage, tuned for judges and admins.
          </p>
        ...
        <section className="mixology-panels">
          ...
          <div className="mixology-card">
            <h2>Item DC calculator preserved</h2>
            <p>
              The original item DC calculator now lives at <strong>/legacy</strong>. Navigation keeps it discoverable while
              signaling that the mixology contest is the primary flow during events.
            </p>
          </div>
          <div className="mixology-card">
