...
It applies to both the new Mixology Rating app and the existing legacy app.  
...
## 3. Theming and Dual-App Design (Mixology vs Legacy)

- The app must support:
  - A **Mixology theme** for the contest experience.
  - A distinct **Legacy theme** for the old app.
- Requirements:
...
- Implementation guidance:
  - Maintain separate theme definitions (e.g., `theme.mixology.ts`, `theme.legacy.ts`, or equivalent).
  - Use theme providers or layout wrappers to scope the Mixology theme and the Legacy theme to the appropriate parts of the tree.
