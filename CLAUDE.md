...
This project is indexed by GitNexus as **romantic-brattain** (890 symbols, 2192 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/romantic-brattain/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/romantic-brattain/context` | Codebase overview, check index freshness |
| `gitnexus://repo/romantic-brattain/clusters` | All functional areas |
| `gitnexus://repo/romantic-brattain/processes` | All execution flows |
| `gitnexus://repo/romantic-brattain/process/{name}` | Step-by-step execution trace |
...
> Re-run manually after committing significant code changes.
