...
export const candidateB: CandidatePath = {
  ...
  summary: 'Use fa as the [seventh|seventh-chord] of V7 and [resolve|resolution] it downward to mi.',
  ...
  melodyInterpretations: [
    {
      ...
      role: 'chord_tone',
      explanation: 'Sol is the [root] of V7, [doubled|doubling] by the [bass].',
      evidence: [
        {
          id: 'b-int-sol-1',
          source: 'computed',
    ...
    },
    {
      ...
      explanation:
        'The [soprano]’s fa belongs to V7 as the chordal [seventh|seventh-chord] and [resolves|resolution] by [step] to mi over [tonic].',
      evidence: [
        {
          id: 'b-int-fa-1',
          source: 'computed',
        ...
        },
        {
          ...
          value: true,
          explanation: 'A [dominant seventh|seventh-chord] normally [resolves|resolution] downward.',
  ...
  evidence: [
    {
      ...
      explanation: 'The [roots|root] move sol to do, a descending fifth.',
      providerId: 'fixture',
      providerVersion: '0.1.0',
    },
    {
      ...
      value: 'authentic',
      explanation:
        'V7 to root-position I with stepwise [soprano] descent forms an [authentic cadence|authentic-cadence] shape.',
      providerId: 'poc-hymn-major-v1',
      providerVersion: '0.1.0',
    },
  ],
