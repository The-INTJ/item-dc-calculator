...
export const candidateC: CandidatePath = {
  ...
  melodyInterpretations: [
    ...
    },
    {
      ...
      explanation:
        'Fa passes between sol and mi while the inner voices move through [passing tones|passing-tone] toward the [inversion].',
      evidence: [
        {
          id: 'c-int-fa-1',
          source: 'computed',
    ...
    },
    {
      ...
      role: 'chord_tone',
      explanation:
        'The final sonority remains [tonic], but first [inversion] reduces the sense of root-position closure. Mi is [doubled|doubling] between the outer voices.',
      evidence: [
        {
          id: 'c-int-mi-1',
          source: 'computed',
  ...
  evidence: [
    ...
    },
    {
      ...
      value: true,
      explanation:
        'A first-[inversion] [tonic] keeps tonic function while weakening phrase-final closure.',
      providerId: 'poc-hymn-major-v1',
      providerVersion: '0.1.0',
    },
  ],
