 ...
 *
 * This provider stores data in-memory using seed data.
 ...
 * by implementing ContestBackendProvider.
 */
...
import { MIXOLOGY_CONFIG, cloneConfig } from '../templates';
  ...
  return [
    {
      ...
      phase: 'active',
      config: cloneConfig(MIXOLOGY_CONFIG),
...
export function createInMemoryProvider(): ContestBackendProvider {
  let data: Contest[] = [];
  ...
  return {
    ...
    entries: createEntriesProvider(getData),
