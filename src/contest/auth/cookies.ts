/**
 * Cookie helpers for Contest guest identity and invite metadata.
 */

import type { GuestIdentity, InviteContext } from './types';

const GUEST_ID_COOKIE = 'contest_guest_id';
const GUEST_INDEX_COOKIE = 'contest_guest_index';
const INVITE_CONTEXT_COOKIE = 'contest_invite_context';
